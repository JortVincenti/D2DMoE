...
# modified implementation from: https://github.com/abhuse/pytorch-efficientnet
# TODO perhaps use torchvision instead when EfficientNetV2 reaches stable version
...
class EfficientNetV2(nn.Module):
    ...
    def __init__(self,
        ...
        self.fc = nn.Linear(head_conv_out_channels, self._num_classes)
        if pretrained:
            self._load_state(_input_ch, self._num_classes, progress, tf_style_conv)
