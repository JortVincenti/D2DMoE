...
def main():
    ...
    sparsity_enforcement_args.dsti_enforce_weight = 2e-4 #2e-1  #Jort: Set this to 0 if you want to disable the enforcement
    ...
    sparsity_enforcement_args.final_path_save = 'gelu_sparse_ft'
